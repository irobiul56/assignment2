							...
							<div class="card shadow-sm">
								<div class="card-body">
									<div class="post-header clearfix">
										<img src="<?php echo $post['profilepic'] ?>" alt="">
										<div class="post-user-info">
											<h4><a href="#"><?php echo $post['name'] ?></a></h4>
											<p> <?php echo $post['posttime'] ?> mins <i class="fas fa-globe-americas"></i></p>
										</div>
									...
									<div class="post-likes clearfix">
										<div class="like float-left">
											<img src="assets/media/img/post/like.svg" alt=""> '<?php echo $post['likes']?>'
										</div>
